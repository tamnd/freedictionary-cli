// Package cli assembles the freedictionary command tree from the freedictionary
...
// NewApp assembles the kit application from the freedictionary domain. The
...
//
// To add a command, declare it in freedictionary/domain.go with kit.Handle and
// it appears here automatically.
func NewApp() *kit.App {
	id := freedictionary.Domain{}.Info().Identity
	id.Version = Version

	app := kit.New(id)
	(freedictionary.Domain{}).Register(app)
